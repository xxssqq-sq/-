...
版权所有（c）2002-2011，R.Bryant和D.O'Hallaron
...
此目录下包含你将要运行的CS:APP Data Lab，此lab有助于学生对位表示、二进制补码算法、IEEE 浮点数进行理解。

为了好玩，我们还提供了一个基于HTTP的新的用户级“ Beat the Prof”竞赛，它将取代旧的基于电子邮件的版本。
